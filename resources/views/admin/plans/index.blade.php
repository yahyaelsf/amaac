            ...
            <div class="row">
                ...
                <div class="col-6 dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ route('admin.plans.create') }}" class="text-white btn btn-secondary create-new btn-primary" tabindex="0"
        ...
        table.DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) auth()->user()->can('plans-status') }}
                },
                {
                    data: 'actions_column',
                    searchable: false,
                    ...
                    visible: {{ (int) (auth()->user()->can('plans-store') || auth()->user()->can('plans-delete')) }}
                },
            ]
        });
