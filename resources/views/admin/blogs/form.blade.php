    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <form class="card-body" action="{{ route('admin.blogs.store') }}" method="post" enctype="multipart/form-data">
                    @if ($errors->any())
                    ...
                    @csrf
                    @isset($blog)
                        <input type="hidden" name="pk_i_id" value="{{ $blog->getKey() }}" />
                    @endisset
                    <div class="row mb-5">
                        ...
                        <div class="col-sm-9">
                            <div class="position-relative d-inline-block mx-auto" style="width: 80px; height: 80px;">
                                <label for="coverInput">
                                    <img src="{{ $blog ?  asset($blog->s_cover) : asset('admin/placeholder.jfif') }}"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-username">blog title</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-username" name="s_title" class="form-control"
                                value="{{ $blog->s_title ?? '' }}" placeholder="title blog">
                            @error('s_title')
                     ...
                     <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-username">blog subtitle</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-username" name="s_subtitle" class="form-control"
                                value="{{ $blog->s_subtitle ?? '' }}" placeholder="subtitle blog">
                            @error('s_subtitle')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                      ...
                      <div class="row mb-3">
                        <label for="exampleFormControlSelect1" class="col-sm-3 col-form-label">select category</label>
                             ...
                             <select id="select2Primary" class="select2 form-select" name="categories[]" multiple>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->pk_i_id }}"
                                        @if($blog && $blog->categories->contains('pk_i_id', $category->pk_i_id)) selected @endif>
                                        {{ $category->s_title }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="multicol-username">writer</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-username" name="s_writer" class="form-control"
                                value="{{ $blog->s_writer ?? '' }}" placeholder="writer blog">
                            @error('s_writer')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea id="basic-default-message" name="s_description" class="form-control" placeholder="description blog"
                                rows="5">{{ $blog->s_description ?? '' }}</textarea>
                            @error('s_description')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                                                ...
                                                <figure class="position-relative">
                                                    ...
                                                    @if ($resource->e_type == 'IMAGE')
                                                        <img class="img-thumbnail"
                                                            src="{{ asset($resource->s_filename) }}" />
                                                    @else
                                                        <video width="320" height="240" controls>
                                                            <source src="{{ asset($resource->s_filename) }}"
                                                                type="video/mp4">
                    ...
                    <div class="pt-4">
                        <div class="row justify-content-end">
                            <div class="col-sm-9">
                                ...
                                <a href="{{ route('admin.blogs.index') }}" type="reset"
