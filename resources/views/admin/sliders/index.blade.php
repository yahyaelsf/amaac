            ...
            <div class="row">
                ...
                <div class="col-6 dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <a href="{{ route('admin.sliders.create') }}" class="text-white btn btn-secondary create-new btn-primary" tabindex="0"
        ...
        table.DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) auth()->user()->can('libraries-store') }}
                },
                {
                    data: 'actions_column',
                    searchable: false,
                    ...
                    visible: {{ (int) (auth()->user()->can('libraries-store') || auth()->user()->can('libraries-store')) }}
                },
            ]
        });
