...
@section('content')
    ...
    <div class="container pb-1">
        <div class="row" bis_skin_checked="1">
            <div class="col py-3" bis_skin_checked="1">
            ...
            <div class="featured-boxes featured-boxes-style-2" bis_skin_checked="1">
                <div class="row" bis_skin_checked="1">
                    <div class="col-md-6 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible"
                        data-appear-animation="fadeInRightShorter" data-appear-animation-delay="700" bis_skin_checked="1"
                        ...
                        <div class="featured-box featured-box-effect-4 border rounded p-3" bis_skin_checked="1">
                            <div class="box-content" bis_skin_checked="1">
                                ...
                                <i class="fa-solid fa-shield-halved text-color-white bg-color-primary icon-featured"></i>

                                <h4 class="font-weight-bold text-start text-color-secondary">Civil Rights &
                                    Anti-Discrimination: </h4>
                                <ul class="px-2 text-start text-color-primary">
                    ...
                    <div class="col-md-6 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible"
                        ...
                        <div class="featured-box featured-box-effect-4 border rounded p-3" bis_skin_checked="1">
                            <div class="box-content" bis_skin_checked="1">
                                <i class="fa-solid fa-square-poll-horizontal text-color-white bg-color-primary icon-featured"></i>

                                <h4 class="font-weight-bold text-start text-color-secondary">Civic Engagement & Political
                                    Participation: </h4>
                                <ul class="px-2 text-start text-color-primary">
                    ...
                    <div class="col-md-6 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible"
                        ...
                        <div class="featured-box featured-box-effect-4 border rounded p-3" bis_skin_checked="1">
                            <div class="box-content" bis_skin_checked="1">
                                <i class="fa-solid fa-newspaper text-color-white bg-color-primary icon-featured"></i>
                    ...
                    <div class="col-md-6 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible"
                        ...
                        <div class="featured-box featured-box-effect-4 border rounded p-3" bis_skin_checked="1">
                            <div class="box-content" bis_skin_checked="1">
                                ...
                                <i class="fa-solid fa-passport text-color-white bg-color-primary icon-featured"></i>

                                <h4 class="font-weight-bold text-start text-color-secondary"> Immigration & Refugee Support:
                                </h4>
                                <ul class="px-2 text-start text-color-primary">
                    ...
                    <div class="col-md-6 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible"
                        ...
                        <div class="featured-box featured-box-effect-4 border rounded p-3" bis_skin_checked="1">
                            <div class="box-content" bis_skin_checked="1">
                                <i class="fa-solid fa-scale-balanced text-color-white bg-color-primary icon-featured"></i>

                                <h4 class="font-weight-bold text-start text-color-secondary"> Human Rights & Foreign Policy:
                                </h4>
                                <ul class="px-2 text-start text-color-primary">
                    ...
                    <div class="col-md-6 col-lg-6 appear-animation animated fadeInRightShorter appear-animation-visible"
                        ...
                        <div class="featured-box featured-box-effect-4 border rounded p-3" bis_skin_checked="1">
                            <div class="box-content" bis_skin_checked="1">
                               <i class="fa-solid fa-people-group text-color-white bg-color-primary icon-featured"></i>

                                <h4 class="font-weight-bold text-start text-color-secondary">Youth & Community Development:
                                </h4>
                                <ul class="px-2 text-start text-color-primary">
