                ...
                <div class="row text-center pb-5">
                    <div class="col-md-9 mx-md-auto">
                        <div class="overflow-hidden mb-3">
                            <h1 class="font-weight-bold text-8 mb-0 appear-animation text-color-light" data-appear-animation="maskUp">
        ...
        <div class="row pb-3" bis_skin_checked="1">
            ...
            <div class="accordion accordion-modern " id="accordion" bis_skin_checked="1">
                <div class="card card-default " bis_skin_checked="1">
                    <div class="card-header bg-secondary" bis_skin_checked="1">
                    ...
                    <div id="collapseOne" class="collapse show" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Combating all forms of discrimination and prejudice.</p>
                            <p class="text-color-primary">Promoting public policies that protect the constitutional freedoms
                                of Muslims and Arabs.</p>
                            <p class="text-color-primary"> Monitoring and following up on discriminatory practices in the
                                labor, education, media, and law enforcement sectors. </p>

                        </div>
                    </div>
                </div>
                <div class="card card-default bg-secondary" bis_skin_checked="1">
                    ...
                    <div id="collapseTwo" class="collapse " bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary"> Supporting increased Arab and Muslim representation in local and
                                federal councils. </p>
                            <p class="text-color-primary"> Providing awareness and training programs to enhance political
                ...
                <div class="card card-default" bis_skin_checked="1">
                    ...
                    <div id="collapseThree" class="collapse " bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary"> Organizing artistic and cultural events that highlight Arab and
                                Islamic heritage. </p>
                            <p class="text-color-primary"> Supporting educational initiatives that re-present the image of
                                Islam and Arabism in a civilized manner.</p>
                            <p class="text-color-primary"> Producing and promoting media content that counters stereotypes
                ...
                <div class="card card-default bg-secondary" bis_skin_checked="1">
                    ...
                    <div id="collapseFour" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Launching community dialogue initiatives and promoting
                                solidarity among community members. </p>
                            <p class="text-color-primary"> Encouraging collaborative work across religions and cultures,
                ...
                <div class="card card-default" bis_skin_checked="1">
                    ...
                    <div id="collapseFive" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Advocating for Justice and Equality: We will serve as a strong
                            ...
                            <p class="text-color-primary"> Promoting Civic Engagement: We will encourage Arab and
                            ...
                            <p class="text-color-primary">Supporting Sustainable Development: We will collaborate with
                ...
                <div class="card card-default bg-secondary" bis_skin_checked="1">
                    ...
                    <div id="collapseSix" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            ...
                            <p class="text-color-primary"> Policy Analysis and Recommendations: We will conduct in-depth
                                ...
                                parties. </p>
                            <p class="text-color-primary"> Policy Engagement: We will build strong relationships with
                            ...
                            <p class="text-color-primary">Building Strategic Alliances: We will collaborate with human
                ...
                <div class="card card-default" bis_skin_checked="1">
                    ...
                    <div id="collapse-7" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">We believe that the world is constantly changing, so our vision must
                                be flexible and adaptable: </p>
                            <p class="text-color-primary">Embracing Technology: We will leverage the latest technologies
                                and social media to spread our message, organize our campaigns,
                                and engage with communities around the world. </p>
                            <p class="text-color-primary"> Continuous research and development: We will commit to
                            ...
                            <p class="text-color-primary">Providing workshops and knowledge resources (such as "Know
                                Your Rights" and "Building Community Leadership"). </p>
                            <p class="text-color-primary"> Facilitating access to legal, social, and economic resources. </p>
                        </div>
                    </div>
                </div>
                <div class="card card-default bg-secondary" bis_skin_checked="1">
                    ...
                    <div id="collapse-8" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Primary Objective: Transform negative perceptions of Arabs and
                                Muslims into deeper understanding and mutual appreciation in
                                Western societies. </p>
                            <p class="text-color-primary"> Detailed Objectives:
                            ...
                            <p class="text-color-primary">Developing Innovative Educational Programs: Designing and
                            ...
                            <p class="text-color-primary">Establishing Interfaith and Intercultural Dialogue Platforms:
                            ...
                            <p class="text-color-primary"> Facilitating cultural and academic exchange programs: Launching
                ...
                <div class="card card-default" bis_skin_checked="1">
                    ...
                    <div id="collapse-9" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Primary goal: Empowering Arab and Muslim communities globally
                                and defending their civil and human rights. </p>
                            <p class="text-color-primary"> Detailed goals: Providing legal and moral support to victims of discrimination:
                            ...
                            <p class="text-color-primary"> Launching leadership capacity-building programs: Developing
                            ...
                            <p class="text-color-primary">Supporting sustainable development projects: Collaborating with
                ...
                <div class="card card-default bg-secondary" bis_skin_checked="1">
                    ...
                    <div id="collapse-10" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Primary Objective: For AMAAC to be an influential voice in
                                shaping US foreign policy relevant to the Arab and Islamic world. </p>
                            <p class="text-color-primary"> Detailed Objectives: Conducting in-depth policy research and analysis: Establishing a
                            ...
                            <p class="text-color-primary"> Active Participation in the Decision-Making Process: Building
                                ...
                                recommendations. </p>
                            <p class="text-color-primary">Organizing forums and dialogue conferences with decision
                ...
                <div class="card card-default" bis_skin_checked="1">
                    ...
                    <div id="collapse-11" class="collapse" bis_skin_checked="1" style="">
                        <div class="card-body text-2" bis_skin_checked="1">
                            <p class="text-color-primary">Primary Objective: Ensuring the Council's sustainability and
                                effectiveness by adopting best practices and adapting to changing
                                challenges. </p>
                            <p class="text-color-primary"> Detailed Objectives: Investing in digital technology: Developing modern digital
                            ...
                            <p class="text-color-primary"> Continuous Evaluation and Program Development: Conducting
                                ...
                                impact. </p>
                            <p class="text-color-primary">Building a Global Network of Partners: Establishing strong
