...
class PermissionController extends Controller
{
    ...
    public function form()
    {
        ...
        $parents = TPermission::whereNull('parent_id')->pluck('display_name', 'id');
        // dd($parents);
        return view('admin.permissions.form', compact('permission','parents'));
    }
    ...
    public function process(StorePermissionRequest $request)
    {
        ...
        return redirect()->route('admin.permissions.index')->with('success', trans('alerts.successfully_updated'));
    }
