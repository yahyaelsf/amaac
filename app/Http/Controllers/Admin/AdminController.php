...
class AdminController extends Controller
{
    ...
    public function store(StoreAdminRequest $request)
    {
        ...
        if ($id = $request->get('pk_i_id')) {
            ...
            return redirect()->route('admin.admins.index')->with('success', trans('alerts.successfully_updated'));
        } else {
            return redirect()->route('admin.admins.index')->with('success', trans('alerts.successfully_added'));
        }
